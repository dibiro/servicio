...
class Perido(models.Model):
    ...
    def __unicode__(self):
        return '%s (%s, %s)' % (self.periodo, self.fecha_de_inicio, self.fecha_de_fin)
...
class Registros(models.Model):
    ...
    intitucion = models.ForeignKey(Instituciones, blank=True, null=True)
    ...
    def __unicode__(self):
        return 'Estudiante: %s, Tutor: %s, Escuela: %s)' % (self.estudiante, self.tutor, self.intitucion)
